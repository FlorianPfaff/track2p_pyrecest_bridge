...
from . import identity_switch_scores as _identity_switch_scores
from . import track2p_metrics as _track2p_metrics

complete_track_set = _scores.complete_track_set
identity_switch_events = _identity_switch_scores.identity_switch_events
...
score_identity_switches = _identity_switch_scores.score_identity_switches
...
__all__ = [*_scores.__all__, *_identity_switch_scores.__all__, "score_track_matrix_against_reference"]
